class Percept::Intimacao < Percept::Base
    ...
    def self.situacao_no_periodo start_date, end_date
        ...
        # Classificadas -> revisado=1, statusCPJ=0, status_1 = NOVO
        # Lançadas (inclui sem prazos)  -> status_1 = NOVO, statusCPJ=1 | status_1 = NOVO, revisado=2, statusCPJ=0
        ...
        counts.each do |count|
            if count.revisado == 1 and count.status_cpj == 0 and count.status_1 == "NOVO"
                classificadas = classificadas + count.count
            elsif count.status_cpj == 1 || ( count.status_1 == "NOVO" and count.revisado == 2 )
